...
dir_results <- '/n/home07/yaw624/EME/results/Quadratic_Quadratic/'   ### change directory for saving results
...
simulate_results <- function(key,covar,b0,b1,b2,n.reps){
  ...
  for (i in 1:n.reps){
    ...
    mod_classical_multi_ind_error_sd <- glm(y_classical_multi ~ I(pm25.x+annual_ind_err_sd) + I((pm25.x+annual_ind_err_sd)^2) + ozone_summer + no2 + temp + rh + PctEye + PctLDL + Pctmam + LungCancerRate + poverty
