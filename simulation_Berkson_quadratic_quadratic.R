###############################################################################################
# Project: EME                                                                                #
# Code: simulate mortality with quadratic PM and test with quadratic PM - Berkson error       #
# Author: Yaguang Wei                                                                         #
###############################################################################################
...
dir_results <- '/media/qnap4/Yaguang/EME/results/Berkson/quadratic_quadratic/'
...
simulate_results<-function(key,covar,b0,b1,b2,n.reps,n.obs){
  ...
  for (i in 1:n.reps){
    ...
    y1<-rpois(n.obs,exp(b0+b1*exposure1_star+b2*(exposure1_star^2)+4.795e-04*ozone_summer+7.526e-04*no2+6.693e-04*temp+7.395e-04*rh
    ...
    y2<-rpois(n.obs,exp(b0+b1*exposure2_star+b2*(exposure2_star^2)+4.795e-04*ozone_summer+7.526e-04*no2+6.693e-04*temp+7.395e-04*rh
                        -1.665e-03*PctEye-1.015e-03*PctLDL-1.525e-03*Pctmam+6.110e-01*LungCancerRate
                        +1.920e-01*poverty-4.245e-06*popdensity-2.574e-07*medianhousevalue-4.967e-02*pct_blk
                        -9.385e-07*medhouseholdincome-2.910e-01*pct_owner_occ-2.623e-01*hispanic+1.448e-01*education
                        +9.841e-02*smoke_rate+6.779e-03*mean_bmi+5.998e-04*amb_visit_pct+4.921e-04*a1c_exm_pct-3.336e-03*nearest_hospital_km
    ...
    y3<-rpois(n.obs,exp(b0+b1*exposure3_star+b2*(exposure3_star^2)+4.795e-04*ozone_summer+7.526e-04*no2+6.693e-04*temp+7.395e-04*rh
                        -1.665e-03*PctEye-1.015e-03*PctLDL-1.525e-03*Pctmam+6.110e-01*LungCancerRate
                        +1.920e-01*poverty-4.245e-06*popdensity-2.574e-07*medianhousevalue-4.967e-02*pct_blk
                        -9.385e-07*medhouseholdincome-2.910e-01*pct_owner_occ-2.623e-01*hispanic+1.448e-01*education
                        +9.841e-02*smoke_rate+6.779e-03*mean_bmi+5.998e-04*amb_visit_pct+4.921e-04*a1c_exm_pct-3.336e-03*nearest_hospital_km
    ...
    y4<-rpois(n.obs,exp(b0+b1*exposure4_star+b2*(exposure4_star^2)+4.795e-04*ozone_summer+7.526e-04*no2+6.693e-04*temp+7.395e-04*rh
                        -1.665e-03*PctEye-1.015e-03*PctLDL-1.525e-03*Pctmam+6.110e-01*LungCancerRate
                        +1.920e-01*poverty-4.245e-06*popdensity-2.574e-07*medianhousevalue-4.967e-02*pct_blk
                        -9.385e-07*medhouseholdincome-2.910e-01*pct_owner_occ-2.623e-01*hispanic+1.448e-01*education
                        +9.841e-02*smoke_rate+6.779e-03*mean_bmi+5.998e-04*amb_visit_pct+4.921e-04*a1c_exm_pct-3.336e-03*nearest_hospital_km
    ...
    y5<-rpois(n.obs,exp(b0+b1*exposure5_star+b2*(exposure5_star^2)+4.795e-04*ozone_summer+7.526e-04*no2+6.693e-04*temp+7.395e-04*rh
                        -1.665e-03*PctEye-1.015e-03*PctLDL-1.525e-03*Pctmam+6.110e-01*LungCancerRate
                        +1.920e-01*poverty-4.245e-06*popdensity-2.574e-07*medianhousevalue-4.967e-02*pct_blk
                        -9.385e-07*medhouseholdincome-2.910e-01*pct_owner_occ-2.623e-01*hispanic+1.448e-01*education
                        +9.841e-02*smoke_rate+6.779e-03*mean_bmi+5.998e-04*amb_visit_pct+4.921e-04*a1c_exm_pct-3.336e-03*nearest_hospital_km
    ...
    y6<-rpois(n.obs,exp(b0+b1*exposure6_star+b2*(exposure6_star^2)+4.795e-04*ozone_summer+7.526e-04*no2+6.693e-04*temp+7.395e-04*rh
                        -1.665e-03*PctEye-1.015e-03*PctLDL-1.525e-03*Pctmam+6.110e-01*LungCancerRate
                        +1.920e-01*poverty-4.245e-06*popdensity-2.574e-07*medianhousevalue-4.967e-02*pct_blk
                        -9.385e-07*medhouseholdincome-2.910e-01*pct_owner_occ-2.623e-01*hispanic+1.448e-01*education
                        +9.841e-02*smoke_rate+6.779e-03*mean_bmi+5.998e-04*amb_visit_pct+4.921e-04*a1c_exm_pct-3.336e-03*nearest_hospital_km
    ...
    try1<-glm(y1 ~ exposure + I(exposure^2) + ozone_summer + no2 + temp + rh + PctEye + PctLDL + Pctmam + LungCancerRate + poverty + popdensity + medianhousevalue 
    ...
    try2<-glm(y2 ~ exposure + I(exposure^2) + ozone_summer + no2 + temp + rh + PctEye + PctLDL + Pctmam + LungCancerRate + poverty + popdensity + medianhousevalue 
              + pct_blk + medhouseholdincome + pct_owner_occ + hispanic + education + smoke_rate + mean_bmi + amb_visit_pct + a1c_exm_pct + nearest_hospital_km 
              + year2001 + year2002 + year2003 + year2004 + year2005 + year2006 + year2007 + year2008 
              + year2009 + year2010 + year2011 + year2012 + year2013 + year2014 + year2015 + year2016 
              + region5_2 + region5_3 + region5_4 + region5_5, family=quasipoisson) 
    
    try3<-glm(y3 ~ exposure + I(exposure^2) + ozone_summer + no2 + temp + rh + PctEye + PctLDL + Pctmam + LungCancerRate + poverty + popdensity + medianhousevalue 
              + pct_blk + medhouseholdincome + pct_owner_occ + hispanic + education + smoke_rate + mean_bmi + amb_visit_pct + a1c_exm_pct + nearest_hospital_km 
              + year2001 + year2002 + year2003 + year2004 + year2005 + year2006 + year2007 + year2008 
              + year2009 + year2010 + year2011 + year2012 + year2013 + year2014 + year2015 + year2016 
              + region5_2 + region5_3 + region5_4 + region5_5, family=quasipoisson) 
    
    try4<-glm(y4 ~ exposure + I(exposure^2) + ozone_summer + no2 + temp + rh + PctEye + PctLDL + Pctmam + LungCancerRate + poverty + popdensity + medianhousevalue 
              + pct_blk + medhouseholdincome + pct_owner_occ + hispanic + education + smoke_rate + mean_bmi + amb_visit_pct + a1c_exm_pct + nearest_hospital_km 
              + year2001 + year2002 + year2003 + year2004 + year2005 + year2006 + year2007 + year2008 
              + year2009 + year2010 + year2011 + year2012 + year2013 + year2014 + year2015 + year2016 
              + region5_2 + region5_3 + region5_4 + region5_5, family=quasipoisson) 
    
    try5<-glm(y5 ~ exposure + I(exposure^2) + ozone_summer + no2 + temp + rh + PctEye + PctLDL + Pctmam + LungCancerRate + poverty + popdensity + medianhousevalue 
              + pct_blk + medhouseholdincome + pct_owner_occ + hispanic + education + smoke_rate + mean_bmi + amb_visit_pct + a1c_exm_pct + nearest_hospital_km 
              + year2001 + year2002 + year2003 + year2004 + year2005 + year2006 + year2007 + year2008 
              + year2009 + year2010 + year2011 + year2012 + year2013 + year2014 + year2015 + year2016 
              + region5_2 + region5_3 + region5_4 + region5_5, family=quasipoisson) 
    
    try6<-glm(y6 ~ exposure + I(exposure^2) + ozone_summer + no2 + temp + rh + PctEye + PctLDL + Pctmam + LungCancerRate + poverty + popdensity + medianhousevalue 
              + pct_blk + medhouseholdincome + pct_owner_occ + hispanic + education + smoke_rate + mean_bmi + amb_visit_pct + a1c_exm_pct + nearest_hospital_km 
              + year2001 + year2002 + year2003 + year2004 + year2005 + year2006 + year2007 + year2008 
              + year2009 + year2010 + year2011 + year2012 + year2013 + year2014 + year2015 + year2016 
              + region5_2 + region5_3 + region5_4 + region5_5, family=quasipoisson) 
